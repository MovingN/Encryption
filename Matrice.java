...
public class Matrice {
    ...
    char mv[][];//matrice di caratteri
    String verme;//key

    public Matrice(String verme) {
        this.mv = new char[26][26];//matrice 26x26 con 4 thread che si occuperanno del suo popolamento, un quadrante per thread
            this.verme = verme;//inserimento key
    }
    ...
    public void stampa() {
        ...
        for (r = 0; r < 26; r++) {
            for (c = 0; c < 26; c++) {//for che servono per navigare la matrice
